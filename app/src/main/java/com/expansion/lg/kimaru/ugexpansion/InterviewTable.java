...
public class InterviewTable extends SQLiteOpenHelper {
    ...
    public List<Interview> getInterviewData() {
        ...
        String [] columns=new String[]{APPLICANT, RECRUITMENT, MOTIVATION, COMMUNITY,MENTALITY,
        ...
        for (cursor.moveToFirst(); !cursor.isAfterLast();cursor.moveToNext()){
            ...
            interview.setApplicant(cursor.getInt(0));
            interview.setRecruitment(cursor.getInt(1));
            interview.setMotivation(cursor.getInt(2));
            interview.setCommunity(cursor.getInt(3));
            interview.setMentality(cursor.getInt(4));
            interview.setSelling(cursor.getInt(5));
            interview.setHealth(cursor.getInt(6));
            interview.setInvestment(cursor.getInt(7));
            interview.setInterpersonal(cursor.getInt(8));
            interview.setTotal(cursor.getInt(9));
            interview.setSelected(cursor.getInt(10));
            interview.setAddedBy(cursor.getInt(11));
            interview.setComment(cursor.getString(12));
            interview.setCommitment(cursor.getInt(13));
            interview.setDateAdded(cursor.getInt(14));
            interview.setSynced(cursor.getInt(15));
